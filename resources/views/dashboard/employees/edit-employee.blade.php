...
@section('container')
    ...
    <div class="card col-lg-8">
        <div class="card-body">
            ...
            <form class="row g-3" method="post" action="/dashboard/members/{{ $employee->name }}"
                ...
                <div class="col-md-12">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('nik') is-invalid @enderror" id="floatingNik"
                            placeholder="Number ID" name="nik" value="{{ old('nik', $employee->nik) }}" required>
                ...
                <div class="col-md-12">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="floatingName"
                            placeholder="Real Name" name="name" value="{{ old('name', $employee->name) }}" required>
                ...
                <div class="col-md-8">
                    <div class="form-floating">
                        <input type="date" class="form-control @error('birth_date') is-invalid @enderror"
                            id="floatingDate" name="birth_date" value="{{ old('birth_date', $employee->birth_date) }}">
                ...
                <div class="col-md-4">
                    <div class="form-floating mb-3">
                        <select class="form-select @error('gender') is-invalid @enderror" id="floatingGender"
                            ...
                            <option value="" {{ old('gender', $employee->gender) === null ? 'selected' : '' }}>Choose
                            </option>
                            <option value="1" {{ old('gender', $employee->gender) == 'Pria' ? 'selected' : '' }}>Male
                            </option>
                            <option value="2" {{ old('gender', $employee->gender) == 'Wanita' ? 'selected' : '' }}>
                                Female
                            </option>
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="floatingEmail"
                            placeholder="User Email" name="email" value="{{ old('email', $employee->email) }}" required>
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('phone') is-invalid @enderror" id="floatingPhone"
                            placeholder="Phone" name="phone" value="{{ old('phone', $employee->phone) }}" required>
                ...
                <div class="col-md-12">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('expertise') is-invalid @enderror"
                            ...
                            value="{{ old('expertise', $employee->expertise) }}" required>
                ...
                <div class="col-md-12">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-11">
                            @if ($employee->photo)
                                <img src="/storage/{{ $employee->photo }}" class="img-preview img-fluid mb-2 col-sm-3">
                            @else
