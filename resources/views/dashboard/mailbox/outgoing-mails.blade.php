                                    ...
                                    @foreach ($mails as $mail)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('outgoing-mails.show', ['number' => urlencode($mail->number)]) }}"
                                                    class="btn btn-primary"><i class="bi bi-eye"></i></a>
                                                <a href="/dashboard/mails/outgoing-mails/{{ $mail->number }}/edit"
                                                    class="btn btn-warning"><i class="bi bi-pencil-fill"></i></a>
                                                <form action="/dashboard/mails/outgoing-mails/{{ $mail->number }}"
